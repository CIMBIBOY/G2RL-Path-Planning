...
if __name__ == '__main__':
    ...
    print(device)
    save_path = "G2RL-Path-Planning/models/model_test.pkl"
    load_path = "G2RL-Path-Planning/models/1220_2.pkl"
    ...
    print("step growth rate",step_all/(94*num_finished_episodes))
