...
'''
python3 main.py --train_name action_mask_fix --seed 503 --method mppo --train scratch --total_timesteps 20480000 --num_steps 128 --cmd_log 5 --num_envs 4 --target_kl 0.01 --pygame

python3 main.py --train_name titan --cuda --seed 422 --method mppo --train scratch --total_timesteps 10240000 --num_steps 1024 --cmd_log 5 --learning_rate 3e-5 --num_envs 4 --track
