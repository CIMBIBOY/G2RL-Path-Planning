...
python3 main.py --train_name titan --cuda --seed 420 --method mppo --train scratch --total_timesteps 10240000 --num_steps 1024 --cmd_log 5 --learning_rate 3e-5 --num_envs 4 --track
