...
'''
python3 main.py --render off --method mppo --epochs 100000 --timesteps 1000 --metal cuda --train retrain --model_weights weights/ppo_model_cuda_czm_ppo.pth --batch 256 --train_name czm_ppo --cmd_log 5
...
python3 main.py --render off --method mppo --epochs 100000 --timesteps 1000 --metal cuda --seed 16 --train retrain --model_weights weights/ppo_model_cuda_czm_ppo.pth --batch 512 --train_name czm_ppo --cmd_log 5
'''
